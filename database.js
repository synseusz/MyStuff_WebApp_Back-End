...
exports.createTables = function(conData, callback){
	...
	sql += 'CREATE TABLE IF NOT EXISTS Adverts (id INT NOT NULL AUTO_INCREMENT, title VARCHAR(200), category VARCHAR(100), description LONGTEXT, ItemCondition VARCHAR(20), askingPrice INT, city VARCHAR(30), photo VARCHAR(2048), PRIMARY KEY (id));'
